...
@section('aboutme-container')
   <!-- About Me Subpage -->
   <section data-id="aboutme" class="animated-section">
    ...
    <div class="section-content">
      ...
      <div class="row">
        <div class="col-xs-12 coll-sm-7">
          <p>Have been in the field of Designing and Development for last 5 years.
          </p>
         </div>
          ...
          <div class="info-list">
            <ul>
              ...
              <li>
                ...
                <span class="value"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8feae2eee6e3cfeaf7eee2ffe3eaa1ece0e2">[email&#160;protected]</a></span>
              </li>

              <li>
                <span class="title">Phone</span>
                <span class="value">+9779863163799</span>
              </li>
            </ul>
          </div>
        </div>
                      ...
                      <div class="col-inner">
                        <div class="info-list-w-icon">
                          <div class="info-block-w-icon">
                            ...
                            <div class="ci-text">
                              <h4>Ecommerce</h4>
                              <p>Most popular means of Website in the market.</p>
                            </div>
                          </div>
                          <div class="info-block-w-icon">
                            <div class="ci-icon">
                              ...
                              <h4>Web Design</h4>
                              <p>Designing wonderful web design accordin to the demand and requuirements of the client.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="clients owl-carousel">
                        ...
                        <div class="client-block">
                          <a href="#" target="_blank" title="Logo">
                            ...
                            <h4>Sabhyata Little Stars'</h4>
                          </a>
                        </div>
                        <div class="client-block">
                          <a href="#" target="_blank" title="Logo">
                            <!-- <img src="img/clients/client-1.png" alt="Logo"> -->
                            <h4>British Language Academy</h4>
                          </a>
                        </div>
                        <div class="client-block">
                          <a href="#" target="_blank" title="Logo">
                  ...
                  <div class="row">
                    <div class=" col-xs-12 col-sm-12 ">
                      <div class="fw-pricing clearfix row">
                        ...
                        <div class="fw-package-wrap col-md-3 ">
                          <div class="fw-package ">
                            ...
                            <div class="fw-button-row">
                              <a href="#" target="_self" class="btn btn-secondary">Select</a>
                            </div>

                            <div class="fw-default-row">3 Posts / Banner Design</div>
                            <div class="fw-default-row">$10 Boosting</div>
                            <div class="fw-default-row">Occassional Design</div>
                            <div class="fw-default-row">Page Management</div>
                          </div>
                        </div>
                        <div class="fw-package-wrap col-md-3 ">
                          <div class="fw-package">
                            ...
                            <div class="fw-default-row">5 Posts / Banner Design</div>
                            <div class="fw-default-row">$20 Boosting</div>
                            <div class="fw-default-row">Occassional Design</div>
                            <div class="fw-default-row">Page Management</div>
                          </div>
                        </div>
                        <div class="fw-package-wrap col-md-3 ">
                          <div class="fw-package">
                            ...
                            <div class="fw-default-row">8 Posts / Banner Design</div>
                            <div class="fw-default-row">$35 Boosting</div>
                            <div class="fw-default-row">Occassional Design</div>
                            <div class="fw-default-row">Page/ SEO Management</div>
                          </div>
                        </div>
                        <div class="fw-package-wrap col-md-3 ">
                          <div class="fw-package">
                            ...
                            <div class="fw-default-row"10 Posts / Banner Design</div>
                            <div class="fw-default-row">$70 Boosting</div>
                            <div class="fw-default-row">Occassional Design</div>
                            <div class="fw-default-row">Page/ SEO Management</div>
                          </div>
                        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4">
                      <div class="fun-fact gray-default">
                        ...
                        <h4>Working Hours</h4>
                        <span class="fun-fact-block-value">30 hrs/ week</span>
                        <span class="fun-fact-block-text"></span>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4">
                      ...
                      <div class="lm-info-block gray-default">
                        ...
                        <h4><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="73121f160b33160b121e031f165d101c1e">[email&#160;protected]</a></h4>
                        <span class="lm-info-block-value"></span>
                        <span class="lm-info-block-text"></span>
                      </div>
